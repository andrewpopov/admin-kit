...
function ApiKeysPanelImpl({ adapter, title = "API keys", headerPresentation = "section", headerActions, createInput, renderCreate, renderEdit, renderKeys, renderPosture, renderShortcuts, scopeGroups, minimumScopeCount, className, dialogClassName, formatTimestamp, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("section", { className: ["admin-kit__keys", className].filter(Boolean).join(" "), "aria-label": title, children: [panelHeader({ total: lifecycleKeys.length, active: activeCount }), loadError ? ((0, jsx_runtime_1.jsx)(AdminPanelState_1.AdminPanelStateView, { state: { kind: "error", detail: loadError, onRetry: () => void load() } })) : null, actionError ? ((0, jsx_runtime_1.jsx)("p", { className: "admin-kit__action-error", role: "alert", children: actionError })) : null, secret ? ((0, jsx_runtime_1.jsxs)("div", { className: "admin-kit__secret", role: "alert", children: [(0, jsx_runtime_1.jsx)("strong", { children: "Copy this secret now. It will not be shown again." }), (0, jsx_runtime_1.jsx)("code", { children: secret }), (0, jsx_runtime_1.jsxs)("div", { className: "admin-kit__secret-actions", children: [(0, jsx_runtime_1.jsx)("button", { className: "admin-kit__button admin-kit__button--primary", type: "button", onClick: () => void copySecret(), children: "Copy secret" }), (0, jsx_runtime_1.jsx)("button", { className: "admin-kit__button", type: "button", onClick: () => setSecret(undefined), children: "I copied it" }), copyStatus ? ((0, jsx_runtime_1.jsx)("span", { "aria-live": "polite", className: "admin-kit__secret-status", children: copyStatus })) : null] })] })) : null, renderPosture && postureControls ? renderPosture(postureControls) : null, renderShortcuts && postureControls ? renderShortcuts(postureControls) : null, renderCreate ? (renderCreate({
                ...
                pendingKeyId: pending === "create" ? undefined : pending,
                    ...
                    return ((0, jsx_runtime_1.jsxs)("li", { "aria-busy": isPending, className: "admin-kit__key-card", children: [(0, jsx_runtime_1.jsxs)("div", { className: "admin-kit__key-card-header", children: [(0, jsx_runtime_1.jsxs)("div", { className: "admin-kit__key-identity", children: [(0, jsx_runtime_1.jsx)("strong", { children: key.name }), (0, jsx_runtime_1.jsx)("code", { children: key.maskedKey })] }), (0, jsx_runtime_1.jsx)("span", { className: `admin-kit__state-pill admin-kit__state-pill--key-${key.state}`, children: key.state })] }), (0, jsx_runtime_1.jsxs)("dl", { className: "admin-kit__key-summary", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("dt", { children: "Last used" }), (0, jsx_runtime_1.jsx)("dd", { children: key.lastUsedAt
                                                    ...
                                                    : "never" })] }), key.details?.[0] ? ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("dt", { children: key.details[0].label }), (0, jsx_runtime_1.jsx)("dd", { children: key.details[0].value })] })) : null] }), (0, jsx_runtime_1.jsxs)("details", { className: "admin-kit__key-details-disclosure", children: [(0, jsx_runtime_1.jsxs)("summary", { "aria-label": `Scopes and details for ${key.name}`, children: [key.scopes.length, " ", key.scopes.length === 1 ? "scope" : "scopes"] }), key.scopes.length ? ((0, jsx_runtime_1.jsx)("ul", { className: "admin-kit__scope-chips", children: key.scopes.map((scope) => ((0, jsx_runtime_1.jsx)("li", { className: "admin-kit__scope-chip", children: scope }, scope))) })) : ((0, jsx_runtime_1.jsx)("span", { className: "admin-kit__key-empty", children: "No scopes assigned." })), key.details && key.details.length > 1 ? ((0, jsx_runtime_1.jsx)("dl", { className: "admin-kit__key-details", children: key.details.slice(1).map((detail) => ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("dt", { children: detail.label }), (0, jsx_runtime_1.jsx)("dd", { children: detail.value })] }, detail.label))) })) : null] }), key.state === "active" ? ((0, jsx_runtime_1.jsxs)("div", { className: "admin-kit__key-actions", children: [builtInEditEnabled ? ((0, jsx_runtime_1.jsx)("button", { className: "admin-kit__key-edit-btn", type: "button", "aria-label": `Edit scopes for ${key.name}`, "aria-expanded": isEditing, "aria-controls": `admin-kit-key-edit-${key.id}`, disabled: isPending, onClick: () => setEditingKeyId(isEditing ? undefined : key.id), children: "Edit scopes" })) : null, adapter.rotate ? ((0, jsx_runtime_1.jsx)("button", { type: "button", "aria-label": `Rotate ${key.name}`, disabled: isPending, onClick: () => requestRotate?.(key), children: "Rotate" })) : null, adapter.update && renderEdit
                                        ? renderEdit({
                                            key,
                                            update: (input) => update(key, input),
                                            pending: isPending,
                                        })
                                        : null, (0, jsx_runtime_1.jsx)("button", { type: "button", "aria-label": `Revoke ${key.name}`, disabled: isPending, onClick: () => requestRevoke(key), children: "Revoke" })] })) : null, isEditing && scopeGroups ? ((0, jsx_runtime_1.jsxs)("div", { className: "admin-kit__key-edit", id: `admin-kit-key-edit-${key.id}`, role: "region", "aria-label": `Edit scopes for ${key.name}`, children: [(0, jsx_runtime_1.jsxs)("div", { className: "admin-kit__key-edit-header", children: [(0, jsx_runtime_1.jsx)("h3", { children: "Edit scopes" }), (0, jsx_runtime_1.jsxs)("p", { children: [key.name, " \u00B7 ", key.maskedKey] })] }), (0, jsx_runtime_1.jsx)(AdminApiKeyForm_1.AdminApiKeyForm, { mode: "edit", scopeGroups: scopeGroups, minimumScopeCount: minimumScopeCount, pending: isPending, initialScopes: key.scopes, onSubmit: async (request) => {
