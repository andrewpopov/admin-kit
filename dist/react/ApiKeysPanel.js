 ...
 */
function ApiKeysPanelImpl({ adapter, title = "API keys", createInput, renderCreate, renderEdit, renderKeys, renderPosture, renderShortcuts, scopeGroups, className, dialogClassName, formatTimestamp, }) {
