 ...
 */
function ApiKeysPanelImpl({ adapter, title = "API keys", vocabulary, headerPresentation = "section", headerActions, presentation = "responsive", createInput, renderCreate, renderEdit, renderKeyActions, renderKeys, renderPosture, renderShortcuts, scopeGroups, minimumScopeCount, className, dialogClassName, formatTimestamp, }) {
    ...
    const pluralRef = (0, react_1.useRef)(plural);
    ...
    const load = (0, react_1.useCallback)(async () => {
        ...
        try {
            ...
            if (loadId === latestLoadId.current) {
                setLoadError(reason instanceof Error ? reason.message : `Unable to load ${pluralRef.current}.`);
            }
        }
    }, [adapter]);
    (0, react_1.useEffect)(() => {
    ...
    const panelHeader = (counts) => ((0, jsx_runtime_1.jsx)(AdminPanelHeader_1.AdminPanelHeader, { actions: headerActions, className: "admin-kit__keys-header", detail: counts ? ((0, jsx_runtime_1.jsxs)("p", { children: [counts.total, " ", counts.total === 1 ? countSingular : countPlural, counts.total > 0 ? ` · ${counts.active} active` : ""] })) : null, presentation: headerPresentation, title: title }));
    if (loadError && !keys)
    ...
    if (!keys)
        return ((0, jsx_runtime_1.jsxs)("section", { className: ["admin-kit__keys", className].filter(Boolean).join(" "), "aria-label": title, children: [panelHeader(), (0, jsx_runtime_1.jsx)(AdminPanelState_1.AdminPanelStateView, { state: { kind: "loading", label: `Loading ${plural}…` } })] }));
    ...
    const renderEditor = (key, isEditing, isPending) => isEditing && scopeGroups ? ((0, jsx_runtime_1.jsxs)("div", { className: "admin-kit__key-edit", id: `admin-kit-key-edit-${key.id}`, role: "region", "aria-label": `Edit scopes for ${key.name}`, children: [(0, jsx_runtime_1.jsxs)("div", { className: "admin-kit__key-edit-header", children: [(0, jsx_runtime_1.jsx)("h3", { children: "Edit scopes" }), (0, jsx_runtime_1.jsxs)("p", { children: [key.name, " \u00B7 ", key.maskedKey] })] }), (0, jsx_runtime_1.jsx)(AdminApiKeyForm_1.AdminApiKeyForm, { mode: "edit", itemNoun: vocabulary?.singular, scopeGroups: scopeGroups, minimumScopeCount: minimumScopeCount, pending: isPending, initialScopes: key.scopes, onSubmit: async (request) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("section", { className: ["admin-kit__keys", className].filter(Boolean).join(" "), "aria-label": title, children: [panelHeader({ total: lifecycleKeys.length, active: activeCount }), loadError ? ((0, jsx_runtime_1.jsx)(AdminPanelState_1.AdminPanelStateView, { state: { kind: "error", detail: loadError, onRetry: () => void load() } })) : null, actionError ? ((0, jsx_runtime_1.jsx)("p", { className: "admin-kit__action-error", role: "alert", children: actionError })) : null, secret ? ((0, jsx_runtime_1.jsxs)("div", { className: "admin-kit__secret", role: "alert", children: [(0, jsx_runtime_1.jsx)("strong", { children: "Copy this secret now. It will not be shown again." }), (0, jsx_runtime_1.jsx)("code", { children: secret }), (0, jsx_runtime_1.jsxs)("div", { className: "admin-kit__secret-actions", children: [(0, jsx_runtime_1.jsx)("button", { className: "admin-kit__button admin-kit__button--primary", type: "button", onClick: () => void copySecret(), children: "Copy secret" }), (0, jsx_runtime_1.jsx)("button", { className: "admin-kit__button", type: "button", onClick: () => setSecret(undefined), children: "I copied it" }), copyStatus ? ((0, jsx_runtime_1.jsx)("span", { "aria-live": "polite", className: "admin-kit__secret-status", children: copyStatus })) : null] })] })) : null, renderPosture && postureControls ? renderPosture(postureControls) : null, renderShortcuts && postureControls ? renderShortcuts(postureControls) : null, renderCreate ? (renderCreate({
            ...
            })) : scopeGroups ? ((0, jsx_runtime_1.jsxs)("details", { className: "admin-kit__key-create", open: createOpen, onToggle: (event) => setCreateOpen(event.currentTarget.open), children: [(0, jsx_runtime_1.jsxs)("summary", { children: [(0, jsx_runtime_1.jsx)("span", { className: "admin-kit__key-create-icon", "aria-hidden": "true", children: "\uFF0B" }), " ", "Create a new ", vocabulary?.singular ?? "key"] }), (0, jsx_runtime_1.jsx)("div", { className: "admin-kit__key-create-body", children: (0, jsx_runtime_1.jsx)(AdminApiKeyForm_1.AdminApiKeyForm, { mode: "create", itemNoun: vocabulary?.singular, scopeGroups: scopeGroups, minimumScopeCount: minimumScopeCount, pending: pending === "create", onSubmit: (request) => void create(request) }) })] })) : createInput !== undefined ? ((0, jsx_runtime_1.jsxs)("button", { type: "button", disabled: pending === "create", onClick: () => void create(createInput), children: ["Create ", singular] })) : null, renderKeys ? (renderKeys({
                keys: lifecycleKeys,
                requestRevoke,
                requestRotate,
                update: adapter.update ? update : undefined,
                pendingKeyId: pending === "create" ? undefined : pending,
            })) : lifecycleKeys.length === 0 ? ((0, jsx_runtime_1.jsx)(AdminPanelState_1.AdminPanelStateView, { state: { kind: "empty", title: `No ${plural} yet.` } })) : resolvedPresentation === "table" ? ((0, jsx_runtime_1.jsx)("div", { className: "admin-kit__table-wrap admin-kit__keys-table-wrap", children: (0, jsx_runtime_1.jsxs)("table", { className: "admin-kit__table admin-kit__keys-table", children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { scope: "col", children: vocabulary ? capitalizedSingular : "Key" }), (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Scope" }), hasDetails ? (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Details" }) : null, (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "State" }), (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Created" }), (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Last used" }), (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Expires" }), (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Actions" })] }) }), (0, jsx_runtime_1.jsx)("tbody", { children: lifecycleKeys.map((key) => {
                ...
                }) })), (0, jsx_runtime_1.jsx)(AdminConfirmationDialog_1.AdminConfirmationDialog, { open: Boolean(confirmation), className: dialogClassName, title: `${confirmation?.action === "rotate" ? "Rotate" : "Revoke"} ${singular}`, description: confirmation?.action === "rotate"
                    ? `The current ${vocabulary?.singular ?? "credential"} will stop working. Copy the replacement secret immediately after rotating it.`
                    : `This ${vocabulary?.singular ?? "credential"} will stop working immediately and cannot be restored.`, confirmLabel: `${confirmation?.action === "rotate" ? "Rotate" : "Revoke"} ${vocabulary?.singular ?? "key"}`, danger: confirmation?.action === "revoke", pending: Boolean(confirmation) && pending === confirmation?.key.id, onCancel: () => setConfirmation(undefined), onConfirm: () => void confirmAction() })] }));
}
/**
