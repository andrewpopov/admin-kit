...
function AdminScopePicker({ groups, value, onChange, disabled, className, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: ["admin-kit__scope-picker", className].filter(Boolean).join(" "), children: [groups.map((group) => {
            ...
            }), unmatchedScopes.length ? ((0, jsx_runtime_1.jsxs)("fieldset", { className: "admin-kit__scope-group", disabled: disabled, children: [(0, jsx_runtime_1.jsx)("legend", { className: "admin-kit__scope-group-legend", children: "Existing scopes" }), (0, jsx_runtime_1.jsx)("p", { className: "admin-kit__scope-group-description", children: "These scopes are not part of the current vocabulary. Keep or remove them explicitly." }), (0, jsx_runtime_1.jsx)("ul", { className: "admin-kit__scope-options", children: unmatchedScopes.map((scope) => ((0, jsx_runtime_1.jsx)("li", { children: (0, jsx_runtime_1.jsxs)("label", { className: "admin-kit__scope-option", "data-selected": "true", children: [(0, jsx_runtime_1.jsx)("input", { checked: true, disabled: disabled, type: "checkbox", value: scope, onChange: () => toggle(scope) }), (0, jsx_runtime_1.jsxs)("span", { className: "admin-kit__scope-option-copy", children: [(0, jsx_runtime_1.jsx)("span", { className: "admin-kit__scope-option-label", children: "Existing scope" }), (0, jsx_runtime_1.jsx)("code", { className: "admin-kit__scope-option-value", children: scope })] })] }) }, scope))) })] })) : null] }));
}
