 ...
 */
function AdminApiKeyForm({ mode, scopeGroups, pending, initialName, initialExpiresInDays, initialScopes, minimumScopeCount = 0, onSubmit, onCancel, submitLabel, itemNoun, }) {
    ...
    const resolvedSubmitLabel = submitLabel ?? (mode === "create" ? `Create ${itemNoun ?? "API key"}` : "Save changes");
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "admin-kit__key-form", children: [mode === "create" ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("p", { className: "admin-kit__key-form-intro", children: itemNoun
