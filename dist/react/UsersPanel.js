...
function MobileCellLabel({ children }) {
    return (0, jsx_runtime_1.jsx)("span", { className: "admin-kit__mobile-cell-label", children: children });
}
/**
...
function UsersPanel({ adapter, title = "Users", headerPresentation = "section", pageSize = 25, query, search: searchOptions = false, presentation = "table", columns, defaultSort, renderHeaderActions, renderUserActions, className, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("section", { className: ["admin-kit__users", className].filter(Boolean).join(" "), "aria-label": title, children: [(0, jsx_runtime_1.jsx)(AdminPanelHeader_1.AdminPanelHeader, { actions: headerPresentation === "section" ? hostHeaderActions : null, className: "admin-kit__users-header", detail: result ? ((0, jsx_runtime_1.jsxs)("p", { children: [result.total, " ", result.total === 1 ? "user" : "users"] })) : null, presentation: headerPresentation, title: title, toolbar: toolbar }), headerPresentation === "section" ? searchControl : null, loadError && !result ? ((0, jsx_runtime_1.jsx)(AdminPanelState_1.AdminPanelStateView, { state: { kind: "error", detail: loadError, onRetry: () => void load() } })) : !result ? ((0, jsx_runtime_1.jsx)(AdminPanelState_1.AdminPanelStateView, { state: { kind: "loading", label: "Loading users…" } })) : result.items.length === 0 ? ((0, jsx_runtime_1.jsx)(AdminPanelState_1.AdminPanelStateView, { state: { kind: "empty", title: "No users found." } })) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [loadError ? ((0, jsx_runtime_1.jsx)(AdminPanelState_1.AdminPanelStateView, { state: { kind: "error", detail: loadError, onRetry: () => void load() } })) : null, actionError ? ((0, jsx_runtime_1.jsx)("p", { className: "admin-kit__action-error", role: "alert", children: actionError })) : null, presentation === "table"
                        ? (() => {
                            if (columns?.length)
                                return ((0, jsx_runtime_1.jsx)("div", { className: "admin-kit__table-wrap admin-kit__users-table-wrap", children: (0, jsx_runtime_1.jsxs)("table", { className: "admin-kit__table admin-kit__users-table admin-kit__users-table--custom", "aria-busy": isLoading, children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsx)("tr", { children: columns.map((column) => {
                                                        ...
                                                        return ((0, jsx_runtime_1.jsx)("th", { "aria-sort": column.sortable
                                                            ...
                                                            .filter(Boolean)
                                                            .join(" ") || undefined, children: [(0, jsx_runtime_1.jsx)(MobileCellLabel, { children: column.label }), column.render(user, {
                                                                reload: load,
                            ...
                            return ((0, jsx_runtime_1.jsx)("div", { className: "admin-kit__table-wrap admin-kit__users-table-wrap", children: (0, jsx_runtime_1.jsxs)("table", { className: `admin-kit__table admin-kit__users-table${hasDetails ? " admin-kit__users-table--with-details" : ""}`, "aria-busy": isLoading, children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { scope: "col", children: "User" }), hasDetails ? (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Details" }) : null, (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Role" }), (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Status" }), hasActions ? (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Actions" }) : null] }) }), (0, jsx_runtime_1.jsx)("tbody", { children: result.items.map((user) => ((0, jsx_runtime_1.jsxs)("tr", { "aria-busy": pendingUserId === user.id, children: [(0, jsx_runtime_1.jsxs)("td", { children: [(0, jsx_runtime_1.jsx)(MobileCellLabel, { children: "User" }), (0, jsx_runtime_1.jsxs)("div", { className: "admin-kit__user-identity", children: [(0, jsx_runtime_1.jsx)("strong", { children: user.label }), user.secondaryLabel ? (0, jsx_runtime_1.jsx)("span", { children: user.secondaryLabel }) : null, user.badges?.length ? ((0, jsx_runtime_1.jsx)("span", { children: user.badges.join(" · ") })) : null] })] }), hasDetails ? ((0, jsx_runtime_1.jsxs)("td", { children: [(0, jsx_runtime_1.jsx)(MobileCellLabel, { children: "Details" }), user.details?.length ? ((0, jsx_runtime_1.jsx)("dl", { className: "admin-kit__user-details", children: user.details.map((detail) => ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("dt", { children: detail.label }), (0, jsx_runtime_1.jsx)("dd", { children: detail.value })] }, detail.label))) })) : ((0, jsx_runtime_1.jsx)("span", { className: "admin-kit__user-empty", children: "\u2014" }))] })) : null, (0, jsx_runtime_1.jsxs)("td", { children: [(0, jsx_runtime_1.jsx)(MobileCellLabel, { children: "Role" }), adapter.roles?.length &&
                                                                adapter.setRole &&
                                                                user.role &&
                                                                user.permissions?.canChangeRole !== false ? ((0, jsx_runtime_1.jsx)("select", { "aria-label": `Role for ${user.label}`, disabled: pendingUserId === user.id, value: user.role.value, onChange: (event) => void updateRole(user.id, event.target.value), children: adapter.roles.map((role) => ((0, jsx_runtime_1.jsx)("option", { value: role.value, children: role.label }, role.value))) })) : user.role ? ((0, jsx_runtime_1.jsx)("span", { className: "admin-kit__user-value", children: user.role.label })) : null] }), (0, jsx_runtime_1.jsxs)("td", { children: [(0, jsx_runtime_1.jsx)(MobileCellLabel, { children: "Status" }), adapter.statuses?.length &&
                                                                adapter.setStatus &&
                                                                user.status &&
                                                                user.permissions?.canChangeStatus !== false ? ((0, jsx_runtime_1.jsx)("select", { "aria-label": `Status for ${user.label}`, disabled: pendingUserId === user.id, value: user.status.value, onChange: (event) => void updateStatus(user.id, event.target.value), children: adapter.statuses.map((status) => ((0, jsx_runtime_1.jsx)("option", { value: status.value, children: status.label }, status.value))) })) : user.status ? ((0, jsx_runtime_1.jsx)("span", { className: "admin-kit__user-value", children: user.status.label })) : null] }), hasActions ? ((0, jsx_runtime_1.jsxs)("td", { children: [(0, jsx_runtime_1.jsx)(MobileCellLabel, { children: "Actions" }), (0, jsx_runtime_1.jsx)("div", { className: "admin-kit__user-controls", children: renderUserActions
