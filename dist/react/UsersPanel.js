...
function UsersPanel({ adapter, title = "Users", headerPresentation = "section", pageSize = 25, query, search: searchOptions = false, presentation = "table", columns, defaultSort, renderHeaderActions, renderUserActions, className, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("section", { className: ["admin-kit__users", className].filter(Boolean).join(" "), "aria-label": title, children: [(0, jsx_runtime_1.jsx)(AdminPanelHeader_1.AdminPanelHeader, { actions: headerActions, className: "admin-kit__users-header", detail: result ? ((0, jsx_runtime_1.jsxs)("p", { children: [result.total, " ", result.total === 1 ? "user" : "users"] })) : null, presentation: headerPresentation, title: title }), headerPresentation === "section" ? searchControl : null, loadError && !result ? ((0, jsx_runtime_1.jsx)(AdminPanelState_1.AdminPanelStateView, { state: { kind: "error", detail: loadError, onRetry: () => void load() } })) : !result ? ((0, jsx_runtime_1.jsx)(AdminPanelState_1.AdminPanelStateView, { state: { kind: "loading", label: "Loading users…" } })) : result.items.length === 0 ? ((0, jsx_runtime_1.jsx)(AdminPanelState_1.AdminPanelStateView, { state: { kind: "empty", title: "No users found." } })) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [loadError ? ((0, jsx_runtime_1.jsx)(AdminPanelState_1.AdminPanelStateView, { state: { kind: "error", detail: loadError, onRetry: () => void load() } })) : null, actionError ? ((0, jsx_runtime_1.jsx)("p", { className: "admin-kit__action-error", role: "alert", children: actionError })) : null, presentation === "table"
                        ? (() => {
                            ...
                            return ((0, jsx_runtime_1.jsx)("div", { className: "admin-kit__table-wrap admin-kit__users-table-wrap", children: (0, jsx_runtime_1.jsxs)("table", { className: `admin-kit__table admin-kit__users-table${hasDetails ? " admin-kit__users-table--with-details" : ""}`, children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { scope: "col", children: "User" }), hasDetails ? (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Details" }) : null, (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Role" }), (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Status" }), hasActions ? (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Actions" }) : null] }) }), (0, jsx_runtime_1.jsx)("tbody", { children: result.items.map((user) => ((0, jsx_runtime_1.jsxs)("tr", { "aria-busy": pendingUserId === user.id, children: [(0, jsx_runtime_1.jsx)("td", { children: (0, jsx_runtime_1.jsxs)("div", { className: "admin-kit__user-identity", children: [(0, jsx_runtime_1.jsx)("strong", { children: user.label }), user.secondaryLabel ? (0, jsx_runtime_1.jsx)("span", { children: user.secondaryLabel }) : null, user.badges?.length ? ((0, jsx_runtime_1.jsx)("span", { children: user.badges.join(" · ") })) : null] }) }), hasDetails ? ((0, jsx_runtime_1.jsx)("td", { children: user.details?.length ? ((0, jsx_runtime_1.jsx)("dl", { className: "admin-kit__user-details", children: user.details.map((detail) => ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("dt", { children: detail.label }), (0, jsx_runtime_1.jsx)("dd", { children: detail.value })] }, detail.label))) })) : ((0, jsx_runtime_1.jsx)("span", { className: "admin-kit__user-empty", children: "\u2014" })) })) : null, (0, jsx_runtime_1.jsx)("td", { children: adapter.roles?.length &&
                                                            adapter.setRole &&
                                                            user.role &&
