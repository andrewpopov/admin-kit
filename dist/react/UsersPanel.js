 ...
 */
function UsersPanel({ adapter, title = "Users", pageSize = 25, query, search: searchOptions = false, presentation = "table", columns, defaultSort, renderHeaderActions, renderUserActions, className, }) {
