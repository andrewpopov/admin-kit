 ...
 */
function UsersPanel({ adapter, pageSize = 25, query, search: searchOptions = false, renderHeaderActions, renderUserActions, className, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("section", { className: ["admin-kit__users", className].filter(Boolean).join(" "), "aria-label": "Users", children: [(0, jsx_runtime_1.jsxs)("header", { className: "admin-kit__users-header", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h2", { children: "Users" }), result ? (0, jsx_runtime_1.jsxs)("p", { children: [result.total, " ", result.total === 1 ? "user" : "users"] }) : null] }), renderHeaderActions ? renderHeaderActions({ reload: load, isLoading }) : null] }), searchOptions !== false ? ((0, jsx_runtime_1.jsxs)("label", { className: "admin-kit__users-search", children: [(0, jsx_runtime_1.jsx)("span", { children: searchOptions.label ?? "Search users" }), (0, jsx_runtime_1.jsx)("input", { onChange: (event) => setSearchAndResetPage(event.target.value), placeholder: searchOptions.placeholder ?? "Search by name or email", type: "search", value: search })] })) : null, error ? ((0, jsx_runtime_1.jsx)(AdminPanelState_1.AdminPanelStateView, { state: { kind: "error", detail: error, onRetry: () => void load() } })) : !result ? ((0, jsx_runtime_1.jsx)(AdminPanelState_1.AdminPanelStateView, { state: { kind: "loading", label: "Loading users…" } })) : result.items.length === 0 ? ((0, jsx_runtime_1.jsx)(AdminPanelState_1.AdminPanelStateView, { state: { kind: "empty", title: "No users found." } })) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("ul", { className: "admin-kit__users-list", children: result.items.map((user) => ((0, jsx_runtime_1.jsxs)("li", { className: "admin-kit__user", "aria-busy": pendingUserId === user.id, children: [(0, jsx_runtime_1.jsxs)("div", { className: "admin-kit__user-identity", children: [(0, jsx_runtime_1.jsx)("strong", { children: user.label }), user.secondaryLabel ? (0, jsx_runtime_1.jsx)("span", { children: user.secondaryLabel }) : null, user.badges?.length ? (0, jsx_runtime_1.jsx)("span", { children: user.badges.join(" · ") }) : null, user.details?.length ? ((0, jsx_runtime_1.jsx)("dl", { className: "admin-kit__user-details", children: user.details.map((detail) => ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("dt", { children: detail.label }), (0, jsx_runtime_1.jsx)("dd", { children: detail.value })] }, detail.label))) })) : null] }), (0, jsx_runtime_1.jsxs)("div", { className: "admin-kit__user-controls", children: [user.role && !(adapter.roles?.length && adapter.setRole) ? (0, jsx_runtime_1.jsx)("span", { className: "admin-kit__user-value", children: user.role.label }) : null, user.status && !(adapter.statuses?.length && adapter.setStatus) ? (0, jsx_runtime_1.jsx)("span", { className: "admin-kit__user-value", children: user.status.label }) : null, adapter.roles?.length && adapter.setRole && user.role ? ((0, jsx_runtime_1.jsxs)("label", { children: [(0, jsx_runtime_1.jsx)("span", { children: "Role" }), (0, jsx_runtime_1.jsx)("select", { "aria-label": `Role for ${user.label}`, disabled: pendingUserId === user.id, value: user.role.value, onChange: (event) => void updateRole(user.id, event.target.value), children: adapter.roles.map((role) => (0, jsx_runtime_1.jsx)("option", { value: role.value, children: role.label }, role.value)) })] })) : null, adapter.statuses?.length && adapter.setStatus && user.status ? ((0, jsx_runtime_1.jsxs)("label", { children: [(0, jsx_runtime_1.jsx)("span", { children: "Status" }), (0, jsx_runtime_1.jsx)("select", { "aria-label": `Status for ${user.label}`, disabled: pendingUserId === user.id, value: user.status.value, onChange: (event) => void updateStatus(user.id, event.target.value), children: adapter.statuses.map((status) => (0, jsx_runtime_1.jsx)("option", { value: status.value, children: status.label }, status.value)) })] })) : null, renderUserActions
                                            ? renderUserActions(user, {
                                                reload: load,
                                                isPending: pendingUserId === user.id,
                                            })
                                            : null] })] }, user.id))) }), Math.max(1, Math.ceil(result.total / result.pageSize)) > 1 ? ((0, jsx_runtime_1.jsxs)("nav", { className: "admin-kit__pagination", "aria-label": "User pagination", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", disabled: page <= 1, onClick: () => setPage(page - 1), children: "Previous" }), (0, jsx_runtime_1.jsxs)("span", { children: ["Page ", page, " of ", Math.max(1, Math.ceil(result.total / result.pageSize))] }), (0, jsx_runtime_1.jsx)("button", { type: "button", disabled: page >= Math.max(1, Math.ceil(result.total / result.pageSize)), onClick: () => setPage(page + 1), children: "Next" })] })) : null] }))] }));
}
