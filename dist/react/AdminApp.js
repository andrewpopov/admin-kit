...
function AdminApp({ frame, theme, className, ...portalProps }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(AdminTheme_1.AdminTheme, { as: "section", className: "admin-kit__app", theme: theme, children: [frame ? ((0, jsx_runtime_1.jsxs)("header", { className: "admin-kit__app-header", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h1", { children: frame.title }), frame.description ? (0, jsx_runtime_1.jsx)("p", { children: frame.description }) : null] }), frame.actions ? (0, jsx_runtime_1.jsx)("div", { className: "admin-kit__app-actions", children: frame.actions }) : null] })) : null, (0, jsx_runtime_1.jsx)(AdminPortal_1.AdminPortal, { ...portalProps, className: ["admin-kit__app-portal", className].filter(Boolean).join(" "), groups: portalProps.groups })] }));
}
