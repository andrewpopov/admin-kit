...
function OperationalJobsPanel({ adapter, title = "Operational jobs", runLabel = "Run now" }) {
    ...
    return (0, jsx_runtime_1.jsxs)("section", { className: "admin-kit__operations", "aria-label": title, children: [(0, jsx_runtime_1.jsxs)("header", { children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h2", { children: title }), (0, jsx_runtime_1.jsxs)("p", { children: [items.length, " recent runs"] })] }), adapter.run ? (0, jsx_runtime_1.jsx)("button", { disabled: busy, type: "button", onClick: () => void (async () => { setBusy(true); try {
                            ...
                            setBusy(false);
                        } })(), children: runLabel }) : null] }), error ? (0, jsx_runtime_1.jsx)(AdminPanelState_1.AdminPanelStateView, { state: { kind: "error", detail: error, onRetry: () => void load() } }) : null, (0, jsx_runtime_1.jsx)("div", { className: "admin-kit__operations-table-wrap", children: (0, jsx_runtime_1.jsxs)("table", { children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Job" }), (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Started" }), (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Finished" }), (0, jsx_runtime_1.jsx)("th", { scope: "col", children: "Status" })] }) }), (0, jsx_runtime_1.jsx)("tbody", { children: items.map(item => (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsxs)("td", { children: [(0, jsx_runtime_1.jsx)("strong", { children: item.label }), item.detail ? (0, jsx_runtime_1.jsx)("small", { children: item.detail }) : null] }), (0, jsx_runtime_1.jsx)("td", { children: item.startedAt }), (0, jsx_runtime_1.jsx)("td", { children: item.finishedAt ?? "In progress" }), (0, jsx_runtime_1.jsx)("td", { children: (0, jsx_runtime_1.jsx)("span", { className: `admin-kit__state-pill admin-kit__state-pill--${item.state}`, children: item.state }) })] }, item.id)) })] }) })] });
}
